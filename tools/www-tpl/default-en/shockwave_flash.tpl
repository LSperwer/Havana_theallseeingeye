...
<head>
	...
	<title>{{ site.siteName }}: Shockwave & Flash</title>
    ...
    <div id="navi2" class="pngbg clearfix">
		<ul>
			<li class="selected">
				Shockwave & Flash</li>
			<li>
				<a href="{{ site.sitePath }}/help/launcher">Lotus Launcher</a></li>
			<li class=" last">
				<a href="{{ site.sitePath }}/help/faq/*" target="habbohelp" onclick="openOrFocusHelp(this); return false">FAQ</a>
			</li>
		</ul>
    </div>
</div>
		...
		<div id="column1" class="column" style="width: 50%">
			<div class="habblet-container ">		
				<div class="cbb clearfix blue ">
					<h2 class="title">How to use Shockwave & Flash</h2>
					<div class="tutorial-text">	
						<p style="margin-top: 10px">To visit Lotus Hotel, you will need Shockwave and/or Flash Player. Unfortunately, both have reached their end-of-life and are no longer supported in modern browsers (such as Chrome, Firefox, Edge, etc.). </p>
						<p>Fortunately, there are still ways to use Shockwave and Flash. On this page, you will find various options to still visit Lotus Hotel.</p>
						<!-- <p>Simply download Basilisk, extract it to any location on your computer, and run <b>"Start Basilisk."</b> Shockwave and Flash Player are already built-in, so you won't need to download or install them separately.</p>
			...
			<div class="habblet-container ">		
				<div class="cbb clearfix red ">
					...
					<div class="tutorial-text">	
						<p style="margin-top: 10px">There are currently two options for playing Lotus: Shockwave and Flash.</p>
						<p>It is strongly recommended to use the Shockwave version, as it offers many more features that are unavailable on the Flash version.</p>
						<p>Below are the features exclusive to the Shockwave version.</p>
						<div class="row">
							...
							<div class="column" style="margin-top:10px; margin-bottom:10px; margin-left:10px; width: 275px;">
								<p><b>BattleBall, Diving, Wobble Squabble, Trax Machines, Jukeboxes, American Idol, Tic Tac Toe, Chess, Battleships, Poker</b> and some nostalgic components such as the hand and the Room-o-Matic.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div id="column2" class="column" style="width: 305px">	     		
			<div class="habblet-container ">		
				<div class="cbb clearfix">
					<h2 class="title" style="background-color: gray">Basilisk</h2>
					<div class="tutorial-text">							</h2>
						<div class="row">
							<div class="column" style="width: 100px; margin-top:10px; margin-bottom:10px; margin-right:10px">
								<img class="credits-image" src="https://www.basilisk-browser.org/bas-logo-300w.png" alt="" width="100" height="80">
							</div>
							<div class="column" style="width: 165px;">				
						<p style="margin-top:10px">Basilisk is a free, open-source browser that still supports NPAPI plugins. It has a similar look and feel to Firefox and works with classic Firefox extensions, making it a great option for visiting Lotus Hotel.</p>
						<p><b>Download:</b></p>
						<p> - <a href="https://classichabbo.com/classichabbo_exe.zip">Basilisk</a> (95.4 MB)</p>
							</div>
						</div>
			...
			<!-- <div class="habblet-container ">		
				<div class="cbb clearfix">
					<h2 class="title" style="background-color: gray">Lotus Launcher</h2>
					<div class="tutorial-text">							</h2>
						<div class="row">
							<div class="column" style="width: 100px; margin-top:10px; margin-bottom:10px; margin-right:10px">
								<img class="credits-image" src="https://www.basilisk-browser.org/bas-logo-300w.png" alt="" width="100" height="80">
